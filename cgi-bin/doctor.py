...
post = form.getfirst('post', 'none')
post = html.escape(post)
work_exp = form.getfirst('work_exp', 'none')
work_exp = html.escape(work_exp)
...
if flag != 1:
    ...
    VALUES
    ('{}','{}','{}');
    """.format(name, post, work_exp)
    db.execute_query(connection, create_doctor)
    print("""
        <div class="body">
    ...
    print("""
        <div class="body">
        <div class="form"><h2>Врач с таким именем уже есть!</h2>
        </div>
        <div class="form href"> <a href="../index.html">Главная страница</a></div>
        </div>
            """)
